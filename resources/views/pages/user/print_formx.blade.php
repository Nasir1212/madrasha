...
<div class="form-wrapper" id="formArea">
    ...
    <p>
        ফরম নং: <span class="small"></span> &nbsp; &nbsp; তারিখ: <span class="small"></span>
    </p>

    <div class="section-title">ছাত্র/ছাত্রীর তথ্য</div>

    ১) ছাত্র/ছাত্রীর নাম: <span class="line"> <b> {{ $admission->name_bn_first }} {{ $admission->name_bn_last }} ({{ $admission->name_en_first }} {{ $admission->name_en_first }}) </b></span><br><br>
    ২) পিতার নাম: <span class="line"></span><br><br>
